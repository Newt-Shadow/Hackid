...
.field private final d:Lio/sentry/n6;

.field private final e:Lio/sentry/n6;

.field private final f:Ljava/lang/String;

.field private final g:Ljava/lang/String;

.field private final h:Lio/sentry/p6;
...
# direct methods
.method public constructor <init>(Lio/sentry/k6;)V
    .locals 1

    .line 1
    invoke-virtual {p1}, Lio/sentry/k6;->v()Ljava/util/Map;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Lio/sentry/protocol/u;-><init>(Lio/sentry/k6;Ljava/util/Map;)V

    return-void
.end method

.method public constructor <init>(Lio/sentry/k6;Ljava/util/Map;)V
    .locals 4
    ...
    .line 4
    invoke-virtual {p1}, Lio/sentry/k6;->getDescription()Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {p1}, Lio/sentry/k6;->z()Ljava/lang/String;
    ...
    iput-object v0, p0, Lio/sentry/protocol/u;->d:Lio/sentry/n6;

    .line 7
    invoke-virtual {p1}, Lio/sentry/k6;->B()Lio/sentry/n6;

    move-result-object v0

    iput-object v0, p0, Lio/sentry/protocol/u;->e:Lio/sentry/n6;

    .line 8
    invoke-virtual {p1}, Lio/sentry/k6;->G()Lio/sentry/protocol/r;
    ...
    .line 9
    invoke-virtual {p1}, Lio/sentry/k6;->d()Lio/sentry/p6;

    move-result-object v0

    iput-object v0, p0, Lio/sentry/protocol/u;->h:Lio/sentry/p6;

    .line 10
    invoke-virtual {p1}, Lio/sentry/k6;->o()Lio/sentry/l6;

    move-result-object v0

    invoke-virtual {v0}, Lio/sentry/l6;->c()Ljava/lang/String;
    ...
    .line 11
    invoke-virtual {p1}, Lio/sentry/k6;->F()Ljava/util/Map;
    ...
    .line 13
    invoke-virtual {p1}, Lio/sentry/k6;->y()Ljava/util/Map;
    ...
    .line 15
    invoke-virtual {p1}, Lio/sentry/k6;->p()Lio/sentry/y3;
    ...
    .line 16
    :cond_2
    invoke-virtual {p1}, Lio/sentry/k6;->t()Lio/sentry/y3;
    ...
    invoke-virtual {v0, v2}, Lio/sentry/y3;->j(Lio/sentry/y3;)J
    ...
    invoke-virtual {v0}, Lio/sentry/y3;->l()J
    ...
    .line 20
    invoke-virtual {p1}, Lio/sentry/k6;->x()Lio/sentry/metrics/c;
    ...
    .line 21
    invoke-virtual {p1}, Lio/sentry/metrics/c;->a()Ljava/util/Map;
...
.method public constructor <init>(Ljava/lang/Double;Ljava/lang/Double;Lio/sentry/protocol/r;Lio/sentry/n6;Lio/sentry/n6;Ljava/lang/String;Ljava/lang/String;Lio/sentry/p6;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    .locals 0
    ...
    .line 27
    iput-object p4, p0, Lio/sentry/protocol/u;->d:Lio/sentry/n6;

    .line 28
    iput-object p5, p0, Lio/sentry/protocol/u;->e:Lio/sentry/n6;
    ...
    .line 31
    iput-object p8, p0, Lio/sentry/protocol/u;->h:Lio/sentry/p6;
...
.method public e()Lio/sentry/n6;
    ...
    .line 1
    iget-object v0, p0, Lio/sentry/protocol/u;->d:Lio/sentry/n6;
...
.method public serialize(Lio/sentry/m2;Lio/sentry/ILogger;)V
    ...
    .line 55
    iget-object v1, p0, Lio/sentry/protocol/u;->d:Lio/sentry/n6;
    ...
    .line 59
    .line 60
    iget-object v0, p0, Lio/sentry/protocol/u;->e:Lio/sentry/n6;
    ...
    .line 70
    iget-object v1, p0, Lio/sentry/protocol/u;->e:Lio/sentry/n6;
    ...
    .line 101
    :cond_2
    iget-object v0, p0, Lio/sentry/protocol/u;->h:Lio/sentry/p6;
    ...
    .line 111
    iget-object v1, p0, Lio/sentry/protocol/u;->h:Lio/sentry/p6;
