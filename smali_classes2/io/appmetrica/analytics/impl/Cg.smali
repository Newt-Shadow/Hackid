...
.method public constructor <init>()V
    ...
    invoke-direct/range {v0 .. v6}, Lio/appmetrica/analytics/impl/Cg;-><init>(Lio/appmetrica/analytics/impl/ln;Lio/appmetrica/analytics/impl/Q;Lio/appmetrica/analytics/impl/v6;Lio/appmetrica/analytics/impl/ml;Lio/appmetrica/analytics/impl/Fe;Lio/appmetrica/analytics/impl/Ge;)V
...
.method public constructor <init>(Lio/appmetrica/analytics/impl/ln;Lio/appmetrica/analytics/impl/Q;Lio/appmetrica/analytics/impl/v6;Lio/appmetrica/analytics/impl/ml;Lio/appmetrica/analytics/impl/Fe;Lio/appmetrica/analytics/impl/Ge;)V
    ...
    .line 3
    iput-object p1, p0, Lio/appmetrica/analytics/impl/Cg;->a:Lio/appmetrica/analytics/impl/ln;

    .line 4
    iput-object p2, p0, Lio/appmetrica/analytics/impl/Cg;->b:Lio/appmetrica/analytics/impl/Q;

    .line 5
    iput-object p3, p0, Lio/appmetrica/analytics/impl/Cg;->c:Lio/appmetrica/analytics/impl/v6;

    .line 6
    iput-object p4, p0, Lio/appmetrica/analytics/impl/Cg;->d:Lio/appmetrica/analytics/impl/ml;

    .line 7
    iput-object p5, p0, Lio/appmetrica/analytics/impl/Cg;->e:Lio/appmetrica/analytics/impl/Fe;

    .line 8
    iput-object p6, p0, Lio/appmetrica/analytics/impl/Cg;->f:Lio/appmetrica/analytics/impl/Ge;
...
# virtual methods
.method public final a(Lio/appmetrica/analytics/impl/m6;)Lio/appmetrica/analytics/impl/Bg;
    .locals 0
...
.method public final a(Lio/appmetrica/analytics/impl/Bg;)Lio/appmetrica/analytics/impl/m6;
    .locals 3
    ...
    .line 2
    iget-object v1, p1, Lio/appmetrica/analytics/impl/Bg;->a:Ljava/lang/String;

    iget-object v2, v0, Lio/appmetrica/analytics/impl/m6;->f:Ljava/lang/String;
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/m6;->f:Ljava/lang/String;

    .line 3
    iget-object p1, p1, Lio/appmetrica/analytics/impl/Bg;->b:Lio/appmetrica/analytics/impl/wn;
    ...
    .line 5
    iget-object v2, p0, Lio/appmetrica/analytics/impl/Cg;->a:Lio/appmetrica/analytics/impl/ln;
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/m6;->a:Lio/appmetrica/analytics/impl/q6;
    ...
    .line 7
    iget-object v2, p0, Lio/appmetrica/analytics/impl/Cg;->b:Lio/appmetrica/analytics/impl/Q;

    invoke-virtual {v2, v1}, Lio/appmetrica/analytics/impl/Q;->a(Lio/appmetrica/analytics/impl/P;)Lio/appmetrica/analytics/impl/g6;

    move-result-object v1

    iput-object v1, v0, Lio/appmetrica/analytics/impl/m6;->b:Lio/appmetrica/analytics/impl/g6;
    ...
    .line 9
    iget-object v2, p0, Lio/appmetrica/analytics/impl/Cg;->d:Lio/appmetrica/analytics/impl/ml;

    invoke-virtual {v2, v1}, Lio/appmetrica/analytics/impl/ml;->a(Ljava/util/List;)[Lio/appmetrica/analytics/impl/o6;

    move-result-object v1

    iput-object v1, v0, Lio/appmetrica/analytics/impl/m6;->e:[Lio/appmetrica/analytics/impl/o6;

    .line 10
    :cond_2
    iget-object v1, p1, Lio/appmetrica/analytics/impl/wn;->g:Ljava/lang/String;

    iget-object v2, v0, Lio/appmetrica/analytics/impl/m6;->c:Ljava/lang/String;
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/m6;->c:Ljava/lang/String;

    .line 11
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Cg;->c:Lio/appmetrica/analytics/impl/v6;
    ...
    iput v1, v0, Lio/appmetrica/analytics/impl/m6;->d:I
    ...
    .line 13
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Cg;->e:Lio/appmetrica/analytics/impl/Fe;
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/m6;->i:[B
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/m6;->j:[B
    ...
    .line 17
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Cg;->f:Lio/appmetrica/analytics/impl/Ge;
    ...
    iput-object p1, v0, Lio/appmetrica/analytics/impl/m6;->k:[Lio/appmetrica/analytics/impl/i6;
...
.method public final bridge synthetic fromModel(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    check-cast p1, Lio/appmetrica/analytics/impl/Bg;

    .line 2
    .line 3
    invoke-virtual {p0, p1}, Lio/appmetrica/analytics/impl/Cg;->a(Lio/appmetrica/analytics/impl/Bg;)Lio/appmetrica/analytics/impl/m6;
