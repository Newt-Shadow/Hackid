...
.field private static volatile c:Lr5/b;
...
.method private constructor <init>()V
    ...
    .line 8
    .line 9
    iput-object v0, p0, Lr5/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static b()Lr5/b;
    ...
    .line 4
    .line 5
    sget-object v0, Lr5/b;->b:Ljava/lang/Object;
...
.method private final f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    .line 24
    invoke-virtual {v2, p6, v1}, Lt5/d;->c(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lr5/b;->g(Landroid/content/ServiceConnection;)Z
    ...
    .line 46
    .line 47
    iget-object p6, p0, Lr5/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Lr5/b;->h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 83
    :cond_3
    iget-object p1, p0, Lr5/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 90
    iget-object p2, p0, Lr5/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private static final h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 11
    .line 12
    invoke-static {p0, p1, p3, p4, p2}, Lr5/a;->a(Landroid/content/Context;Landroid/content/Intent;ILjava/util/concurrent/Executor;Landroid/content/ServiceConnection;)Z
...
.method public a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    .line 16
    invoke-direct/range {v1 .. v8}, Lr5/b;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 1
    invoke-static {p2}, Lr5/b;->g(Landroid/content/ServiceConnection;)Z
    ...
    .line 6
    .line 7
    iget-object v0, p0, Lr5/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 22
    .line 23
    invoke-static {p1, v0}, Lr5/b;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 39
    :cond_0
    invoke-static {p1, p2}, Lr5/b;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 10
    invoke-direct/range {v0 .. v7}, Lr5/b;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
