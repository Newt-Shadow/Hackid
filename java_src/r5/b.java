...
public class b {
    ...
    private static final Object f28967b = new Object();

    /* renamed from: c  reason: collision with root package name */
    private static volatile b f28968c;
    ...
    private final boolean f(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i10, boolean z10, Executor executor) {
        ...
        if (g(serviceConnection)) {
            ServiceConnection serviceConnection2 = (ServiceConnection) this.f28969a.putIfAbsent(serviceConnection, serviceConnection);
            ...
            try {
                ...
                this.f28969a.remove(serviceConnection, serviceConnection);
            }
        }
    ...
    public void c(Context context, ServiceConnection serviceConnection) {
        if (g(serviceConnection) && this.f28969a.containsKey(serviceConnection)) {
            try {
                e(context, (ServiceConnection) this.f28969a.get(serviceConnection));
                return;
            } finally {
                this.f28969a.remove(serviceConnection);
            }
        }
