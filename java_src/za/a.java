...
public class a implements FlutterPlugin, ActivityAware, EventChannel.StreamHandler, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private EventChannel.EventSink f33590a;
    ...
    private void b(Activity activity) {
        ...
        this.f33591b = findViewById;
        findViewById.getViewTreeObserver().addOnGlobalLayoutListener(this);
    }

    private void c() {
        View view = this.f33591b;
        if (view != null) {
    ...
    public void onGlobalLayout() {
        ...
        if (this.f33591b != null) {
            Rect rect = new Rect();
            this.f33591b.getWindowVisibleDisplayFrame(rect);
            if (rect.height() / this.f33591b.getRootView().getHeight() < 0.85d) {
                r02 = 1;
            } else {
                r02 = 0;
            }
            if (r02 != this.f33592c) {
                this.f33592c = r02;
                EventChannel.EventSink eventSink = this.f33590a;
                if (eventSink != null) {
