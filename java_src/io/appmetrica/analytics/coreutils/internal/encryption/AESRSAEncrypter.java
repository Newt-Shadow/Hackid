...
public class AESRSAEncrypter implements Encrypter {
    ...
    final byte[] a(byte[] bArr, byte[] bArr2, byte[] bArr3, PublicKey publicKey) {
        ...
        try {
            ...
            cipher = Cipher.getInstance(this.f17728b);
        ...
        try {
            ...
            encrypt = new AESEncrypter(this.f17727a, bArr2, bArr3).encrypt(bArr);
    ...
    AESRSAEncrypter(int i10) {
        this.f17727a = AESEncrypter.DEFAULT_ALGORITHM;
        this.f17728b = "RSA/ECB/PKCS1Padding";
    }
}
