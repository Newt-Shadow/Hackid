...
public final class C1577vm extends Cm {
    @Override // io.appmetrica.analytics.impl.Cm
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        byte[] bArr;
        byte[] bArr2;
        C1278jm c1278jm = new C1278jm();
        try {
        ...
        return new If("startup_state", iBinaryDataHelper, new J8(c1278jm, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new Rl());
    }
