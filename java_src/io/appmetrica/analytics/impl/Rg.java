...
public final class Rg implements Function {
    ...
    public final /* synthetic */ C1580w0 f18897a;

    public Rg(C1580w0 c1580w0) {
        this.f18897a = c1580w0;
    }

    @Override // io.appmetrica.analytics.coreapi.internal.backport.Function
    public final Object apply(Object obj) {
        String str = (String) obj;
        C1580w0 c1580w0 = this.f18897a;
        ...
        C1136e4 c1136e4 = new C1136e4("", "", 5897, 0, orCreatePublicLogger);
        if (str != null) {
            c1136e4.f(str);
        }
        c1136e4.f19583m = bundle;
        c1136e4.f19573c = this.f18897a.f20844f.f20896f;
        return c1136e4;
    }
}
