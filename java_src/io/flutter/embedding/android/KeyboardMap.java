...
public class KeyboardMap {
    ...
    public static final PressingGoal[] pressingGoals = {new PressingGoal(Base64Utils.IO_BUFFER_SIZE, new KeyPair[]{new KeyPair(458976, 8589934848L), new KeyPair(458980, 8589934849L)}), new PressingGoal(1, new KeyPair[]{new KeyPair(458977, 8589934850L), new KeyPair(458981, 8589934851L)}), new PressingGoal(2, new KeyPair[]{new KeyPair(458978, 8589934852L), new KeyPair(458982, 8589934853L)})};
