...
public class FlutterActivity extends Activity implements FlutterActivityAndFragmentDelegate.Host, androidx.lifecycle.m {
    ...
    private View createFlutterView() {
        ...
        return flutterActivityAndFragmentDelegate.onCreateView(null, null, null, i10, z10);
    }
    ...
    private OnBackInvokedCallback createOnBackInvokedCallback() {
        ...
        return new OnBackInvokedCallback() { // from class: io.flutter.embedding.android.d
    ...
    public void setFrameworkHandlesBack(boolean z10) {
        ...
        } else if (!z10 && this.hasRegisteredBackCallback) {
            unregisterOnBackInvokedCallback();
        }
    }
