        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            if (this.settings != null) {
                try {
                    ...
                    if (bundle != null) {
                        i10 = bundle.getInt(OLD_GEN_HEAP_SIZE_META_DATA_KEY);
                    } else {
                        i10 = 0;
                    }
                    if (i10 == 0) {
                    ...
                    this.flutterJNI.init(context, (String[]) arrayList.toArray(new String[0]), null, initResult.appStoragePath, initResult.engineCachesPath, SystemClock.uptimeMillis() - this.initStartTimestampMillis, Integer.valueOf(Build.VERSION.SDK_INT).intValue());
