...
class AccessibilityViewEmbedder {
    ...
    public static class ViewAndId {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.f21962id == viewAndId.f21962id && this.view.equals(viewAndId.view)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return ((this.view.hashCode() + 31) * 31) + this.f21962id;
        }
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i10) {
        ...
        if (viewAndId == null || !this.embeddedViewToDisplayBounds.containsKey(viewAndId.view) || viewAndId.view.getAccessibilityNodeProvider() == null || (createAccessibilityNodeInfo = viewAndId.view.getAccessibilityNodeProvider().createAccessibilityNodeInfo(viewAndId.f21962id)) == null) {
            return null;
        }
    ...
    public boolean performAction(int i10, int i11, Bundle bundle) {
        ...
        return accessibilityNodeProvider.performAction(viewAndId.f21962id, i11, bundle);
    }
