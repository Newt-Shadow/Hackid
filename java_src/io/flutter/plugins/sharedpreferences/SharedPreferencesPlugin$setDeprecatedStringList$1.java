...
final class SharedPreferencesPlugin$setDeprecatedStringList$1 extends kotlin.coroutines.jvm.internal.k implements Function2 {
    ...
    public SharedPreferencesPlugin$setDeprecatedStringList$1(SharedPreferencesPlugin sharedPreferencesPlugin, String str, String str2, ad.e eVar) {
        super(2, eVar);
    ...
    public final Object invoke(l0 l0Var, ad.e eVar) {
        return ((SharedPreferencesPlugin$setDeprecatedStringList$1) create(l0Var, eVar)).invokeSuspend(xc.t.f32733a);
    }
}
