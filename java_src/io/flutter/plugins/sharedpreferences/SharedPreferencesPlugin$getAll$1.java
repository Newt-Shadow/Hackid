...
final class SharedPreferencesPlugin$getAll$1 extends kotlin.coroutines.jvm.internal.k implements Function2 {
    ...
    public SharedPreferencesPlugin$getAll$1(SharedPreferencesPlugin sharedPreferencesPlugin, List<String> list, ad.e eVar) {
        super(2, eVar);
    ...
    public final Object invoke(l0 l0Var, ad.e eVar) {
        return ((SharedPreferencesPlugin$getAll$1) create(l0Var, eVar)).invokeSuspend(xc.t.f32733a);
    }
}
