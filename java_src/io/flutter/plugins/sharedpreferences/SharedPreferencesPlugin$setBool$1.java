...
final class SharedPreferencesPlugin$setBool$1 extends kotlin.coroutines.jvm.internal.k implements Function2 {
    ...
    public static final class AnonymousClass1 extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        AnonymousClass1(f.a aVar, boolean z10, ad.e eVar) {
            super(2, eVar);
            this.$boolKey = aVar;
            this.$value = z10;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                xc.m.b(obj);
                ((o0.c) this.L$0).j(this.$boolKey, kotlin.coroutines.jvm.internal.b.a(this.$value));
                return xc.t.f32733a;
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SharedPreferencesPlugin$setBool$1(String str, SharedPreferencesPlugin sharedPreferencesPlugin, boolean z10, ad.e eVar) {
        super(2, eVar);
        this.$key = str;
    ...
    public final Object invoke(l0 l0Var, ad.e eVar) {
        return ((SharedPreferencesPlugin$setBool$1) create(l0Var, eVar)).invokeSuspend(xc.t.f32733a);
    }
}
