...
public class WebViewActivity extends Activity {
    ...
    public static Intent createIntent(Context context, String str, boolean z10, boolean z11, Bundle bundle) {
        return new Intent(context, WebViewActivity.class).putExtra(URL_EXTRA, str).putExtra(ENABLE_JS_EXTRA, z10).putExtra(ENABLE_DOM_EXTRA, z11).putExtra("com.android.browser.headers", bundle);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        androidx.core.content.a.k(this, this.broadcastReceiver, this.closeIntentFilter, 2);
    }
