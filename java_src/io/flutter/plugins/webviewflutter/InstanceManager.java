...
public class InstanceManager {
    ...
    private InstanceManager(FinalizationListener finalizationListener) {
        ...
        handler.postDelayed(new z2(this), CLEAR_FINALIZED_WEAK_REFERENCES_INTERVAL);
    }

    public static /* synthetic */ void a(InstanceManager instanceManager) {
    ...
    public void releaseAllFinalizedInstances() {
        ...
        while (true) {
            ...
            if (weakReference != null) {
                ...
                this.handler.postDelayed(new z2(this), CLEAR_FINALIZED_WEAK_REFERENCES_INTERVAL);
                return;
            }
        }
    }
    ...
    public void stopFinalizationListener() {
        this.handler.removeCallbacks(new z2(this));
