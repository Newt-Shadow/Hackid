...
public enum EnumC0396a1 {
    ...
    static final HashMap<Integer, EnumC0396a1> f11919e0 = new HashMap<>();
    ...
    static {
        EnumC0396a1[] values = values();
        for (int i10 = 0; i10 < 54; i10++) {
            EnumC0396a1 enumC0396a1 = values[i10];
            f11919e0.put(Integer.valueOf(enumC0396a1.f11942a), enumC0396a1);
        }
    }

    EnumC0396a1(int i10, String str) {
        this.f11942a = i10;
        this.f11943b = str;
    }
    ...
    public static EnumC0396a1 a(int i10) {
        EnumC0396a1 enumC0396a1 = f11919e0.get(Integer.valueOf(i10));
        return enumC0396a1 == null ? EVENT_TYPE_UNDEFINED : enumC0396a1;
    }
}
