...
public final class GsonRRIncrementalSourceSerializer implements p, h {
    ...
    public GsonRRIncrementalSourceSerializer(d config) {
        m.e(config, "config");
        this.config = config;
    }

    @Override // com.google.gson.h
    public RRIncrementalSource deserialize(i json, Type typeOfT, g context) {
        m.e(json, "json");
        m.e(typeOfT, "typeOfT");
        m.e(context, "context");
        try {
            return RRIncrementalSource.Companion.fromValue(json.g());
        } catch (Throwable th) {
    ...
    public i serialize(RRIncrementalSource src, Type typeOfSrc, o context) {
        m.e(src, "src");
