...
public class InAppWebViewClientCompat extends WebViewClientCompat {
    ...
    */
    ...
    public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, o oVar) {
        ...
        if (webResourceRequest.isForMainFrame()) {
            ...
            credentialsProposed = null;
            if (this.inAppBrowserDelegate != null) {
                this.inAppBrowserDelegate.didFailNavigation(webResourceRequest.getUrl().toString(), t.a("WEB_RESOURCE_ERROR_GET_CODE") ? oVar.b() : -1, t.a("WEB_RESOURCE_ERROR_GET_DESCRIPTION") ? oVar.a().toString() : "");
            }
        }
        WebViewChannelDelegate webViewChannelDelegate = inAppWebView.channelDelegate;
        if (webViewChannelDelegate != null) {
            webViewChannelDelegate.onReceivedError(WebResourceRequestExt.fromWebResourceRequest(webResourceRequest), WebResourceErrorExt.fromWebResourceError(oVar));
        }
    }
    ...
    */
    public void onReceivedHttpAuthRequest(final android.webkit.WebView r16, final android.webkit.HttpAuthHandler r17, final java.lang.String r18, final java.lang.String r19) {
        ...
        L20:
            ...
            int r3 = r3 + 1
            com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClientCompat.previousAuthRequestFailureCount = r3
            java.util.List<com.pichillilorenzo.flutter_inappwebview_android.types.URLCredential> r3 = com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClientCompat.credentialsProposed
            if (r3 != 0) goto L41
            ...
            com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClientCompat.credentialsProposed = r3
            goto L45
        L41:
            r12 = r18
            r13 = r19
        ...
        L5a:
            ...
            int r5 = com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClientCompat.previousAuthRequestFailureCount
            r14.<init>(r3, r5, r2)
            r2 = r16
    ...
    */
    ...
    @Override // androidx.webkit.WebViewClientCompat
    public void onSafeBrowsingHit(final WebView webView, final WebResourceRequest webResourceRequest, final int i10, final o1.f fVar) {
        WebViewChannelDelegate.SafeBrowsingHitCallback safeBrowsingHitCallback = new WebViewChannelDelegate.SafeBrowsingHitCallback() { // from class: com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClientCompat.5
            ...
            public void defaultBehaviour(SafeBrowsingResponse safeBrowsingResponse) {
                InAppWebViewClientCompat.super.onSafeBrowsingHit(webView, webResourceRequest, i10, fVar);
            }
                ...
                if (action != null) {
                    ...
                    if (intValue != 0) {
                        if (intValue != 1) {
                            ...
                            return true;
                        } else if (t.a("SAFE_BROWSING_RESPONSE_PROCEED")) {
                            fVar.b(isReport);
                            return false;
                        } else {
                            return true;
                        }
                    } else if (t.a("SAFE_BROWSING_RESPONSE_BACK_TO_SAFETY")) {
                        fVar.a(isReport);
                        return false;
                    }
                }
