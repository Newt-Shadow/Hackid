    ...
    public Map<String, Object> getRealSettings(InAppWebViewInterface inAppWebViewInterface) {
        ...
        if (inAppWebViewInterface instanceof InAppWebView) {
            ...
            if (t.a("SAFE_BROWSING_ENABLE")) {
                map.put("safeBrowsingEnabled", Boolean.valueOf(q.h(settings)));
            ...
            if (t.a("DISABLED_ACTION_MODE_MENU_ITEMS")) {
                map.put("disabledActionModeMenuItems", Integer.valueOf(q.b(settings)));
            }
            ...
            if (t.a("FORCE_DARK")) {
                map.put("forceDark", Integer.valueOf(q.d(settings)));
            } else if (i10 >= 29) {
                forceDark = settings.getForceDark();
                map.put("forceDark", Integer.valueOf(forceDark));
            }
            if (t.a("FORCE_DARK_STRATEGY")) {
                map.put("forceDarkStrategy", Integer.valueOf(q.e(settings)));
            }
            ...
            if (t.a("OFF_SCREEN_PRERASTER")) {
                map.put("offscreenPreRaster", Boolean.valueOf(q.f(settings)));
            } else {
            ...
            if (i10 >= 26) {
                HashMap hashMap = new HashMap();
                hashMap.put("rendererRequestedPriority", Integer.valueOf(h.a(inAppWebView)));
                hashMap.put("waivedWhenNotVisible", Boolean.valueOf(i.a(inAppWebView)));
                map.put("rendererPriorityPolicy", hashMap);
            }
            if (t.a("ALGORITHMIC_DARKENING") && i10 >= 29) {
                map.put("algorithmicDarkeningAllowed", Boolean.valueOf(q.i(settings)));
            }
            if (t.a("ENTERPRISE_AUTHENTICATION_APP_LINK_POLICY")) {
                map.put("enterpriseAuthenticationAppLinkPolicyEnabled", Boolean.valueOf(q.c(settings)));
            }
            if (t.a("REQUESTED_WITH_HEADER_ALLOW_LIST")) {
                map.put("requestedWithHeaderOriginAllowList", new ArrayList(q.g(settings)));
            }
        }
        return map;
    }
