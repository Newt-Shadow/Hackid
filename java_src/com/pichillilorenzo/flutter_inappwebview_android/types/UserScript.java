...
public class UserScript {
    ...
    public static UserScript fromMap(Map<String, Object> map) {
        ...
        return new UserScript((String) map.get("groupName"), (String) map.get(ClimateForcast.SOURCE), UserScriptInjectionTime.fromValue(((Integer) map.get("injectionTime")).intValue()), ContentWorld.fromMap((Map) map.get("contentWorld")), new HashSet((List) map.get("allowedOriginRules")));
    }
    ...
    public int hashCode() {
        ...
        return (((((((i10 * 31) + this.source.hashCode()) * 31) + this.injectionTime.hashCode()) * 31) + this.contentWorld.hashCode()) * 31) + this.allowedOriginRules.hashCode();
    }
