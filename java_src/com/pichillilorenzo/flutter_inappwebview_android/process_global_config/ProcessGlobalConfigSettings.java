...
public class ProcessGlobalConfigSettings implements ISettings<ProcessGlobalConfig> {
    ...
    public ProcessGlobalConfig toProcessGlobalConfig(Context context) {
        ...
        if (this.dataDirectorySuffix != null && t.b(context, "STARTUP_FEATURE_SET_DATA_DIRECTORY_SUFFIX")) {
            processGlobalConfig.b(context, this.dataDirectorySuffix);
        }
        if (this.directoryBasePaths != null && t.b(context, "STARTUP_FEATURE_SET_DIRECTORY_BASE_PATHS")) {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            if (value != null) {
                ...
                if (key.equals("dataDirectorySuffix")) {
                    ...
                    this.directoryBasePaths = new DirectoryBasePaths().parse2((Map) value);
                }
            }
        }
        return this;
