...
public abstract class o1 {
    ...
    static final class e extends b {
        ...
        */
        ...
        private static int g(byte[] bArr, long j10, int i10) {
            ...
            while (true) {
                int i13 = i11 + 8;
                if (i13 > i10 || (n1.A(bArr, n1.f8518h + j10) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j10 += 8;
                i11 = i13;
        ...
        private static int h(byte[] bArr, int i10, long j10, int i11) {
            ...
            if (i11 == 1) {
                return o1.j(i10, n1.u(bArr, j10));
            }
            if (i11 == 2) {
                return o1.k(i10, n1.u(bArr, j10), n1.u(bArr, j10 + 1));
            }
            ...
            if (length <= i11 && bArr.length - i11 >= i10) {
                ...
                while (i13 < length) {
                    ...
                    if (charAt2 < c10 && j13 < j14) {
                        long j15 = j13 + j10;
                        n1.K(bArr, j13, (byte) charAt2);
                        j12 = j10;
                        j11 = j15;
                        c11 = c10;
                    } else if (charAt2 < 2048 && j13 <= j14 - 2) {
                        long j16 = j13 + j10;
                        n1.K(bArr, j13, (byte) ((charAt2 >>> 6) | 960));
                        long j17 = j16 + j10;
                        ...
                        long j19 = j13 + j10;
                        n1.K(bArr, j13, (byte) ((charAt2 >>> '\f') | 480));
                        long j20 = j19 + j10;
                        n1.K(bArr, j19, (byte) (((charAt2 >>> 6) & 63) | 128));
                        n1.K(bArr, j20, (byte) ((charAt2 & '?') | 128));
                        j11 = j20 + 1;
                        j12 = 1;
                        c11 = 128;
                    } else if (j13 <= j14 - 4) {
                        ...
                        if (i14 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                long j21 = j13 + 1;
                                n1.K(bArr, j13, (byte) ((codePoint >>> 18) | 240));
                                long j22 = j21 + 1;
                                c11 = 128;
                                n1.K(bArr, j21, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j23 = j22 + 1;
                                n1.K(bArr, j22, (byte) (((codePoint >>> 6) & 63) | 128));
                                j12 = 1;
                                j11 = j23 + 1;
                                n1.K(bArr, j23, (byte) ((codePoint & 63) | 128));
                                i13 = i14;
                            } else {
                                i13 = i14;
                            }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0058, code lost:
            if (com.google.crypto.tink.shaded.protobuf.n1.u(r12, r0) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
            if (com.google.crypto.tink.shaded.protobuf.n1.u(r12, r0) > (-65)) goto L56;
         */
        @Override // com.google.crypto.tink.shaded.protobuf.o1.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
    ...
    public static boolean m(byte[] bArr) {
        return f8536a.c(bArr, 0, bArr.length);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean n(byte[] bArr, int i10, int i11) {
        return f8536a.c(bArr, i10, i11);
    }
}
