...
public interface q1 {
    ...
    void J(int i10, Object obj, d1 d1Var);

    void K(int i10, h0.a aVar, Map map);

    void L(int i10, Object obj, d1 d1Var);

    void M(int i10, List list, d1 d1Var);

    void N(int i10, List list, d1 d1Var);

    void O(int i10, h hVar);
