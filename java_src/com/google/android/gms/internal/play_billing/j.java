...
public abstract class j extends g implements List, RandomAccess {
    ...
    private static final y f7015b = new h(q.f7091f, 0);

    /* renamed from: c  reason: collision with root package name */
    public static final /* synthetic */ int f7016c = 0;

    /* JADX INFO: Access modifiers changed from: package-private */
    public static j p(Object[] objArr, int i10) {
        if (i10 == 0) {
            return q.f7091f;
        }
    ...
    public final y listIterator(int i10) {
        b.b(i10, size(), StreamInformation.KEY_INDEX);
        if (isEmpty()) {
            return f7015b;
        }
