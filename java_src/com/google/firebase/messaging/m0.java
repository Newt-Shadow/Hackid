...
public class m0 {
    ...
    private final Bundle f8944a;

    public m0(Bundle bundle) {
        if (bundle != null) {
            this.f8944a = new Bundle(bundle);
            return;
        }
    ...
    private String w(String str) {
        if (!this.f8944a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v10 = v(str);
            if (this.f8944a.containsKey(v10)) {
                return v10;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f8944a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f8944a);
        for (String str : this.f8944a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
