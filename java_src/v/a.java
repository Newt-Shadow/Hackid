...
public abstract class a {
    ...
    private static final ThreadLocal f31125a = new ThreadLocal();
    ...
    public static int a(double d10, double d11, double d12) {
        ...
        return Color.rgb(e((int) Math.round(d13 * 255.0d), 0, KotlinVersion.MAX_COMPONENT_VALUE), e((int) Math.round(d14 * 255.0d), 0, KotlinVersion.MAX_COMPONENT_VALUE), e((int) Math.round(d15 * 255.0d), 0, KotlinVersion.MAX_COMPONENT_VALUE));
    }
