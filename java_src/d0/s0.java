...
public abstract class s0 {
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f14389a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static int a(Resources resources, int i10, c0.h hVar, int i11) {
    ...
    private static float b(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f14389a) != null) {
            try {
    ...
    public static int h(Context context, final ViewConfiguration viewConfiguration, int i10, int i11, int i12) {
        ...
        return a(resources, d10, new c0.h() { // from class: d0.r0
            @Override // c0.h
    ...
    public static int i(Context context, final ViewConfiguration viewConfiguration, int i10, int i11, int i12) {
        ...
        Objects.requireNonNull(viewConfiguration);
        return a(resources, e10, new c0.h() { // from class: d0.q0
            @Override // c0.h
            public final Object get() {
