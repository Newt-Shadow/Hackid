...
public abstract class e {
    ...
    public class a extends InputConnectionWrapper {
        ...
        public boolean commitContent(InputContentInfo inputContentInfo, int i10, Bundle bundle) {
            if (this.f15589a.a(f.f(inputContentInfo), i10, bundle)) {
                return true;
            }
    ...
    public class b extends InputConnectionWrapper {
        ...
        public boolean performPrivateCommand(String str, Bundle bundle) {
            if (e.e(str, bundle, this.f15590a)) {
                return true;
            }
    ...
    public static InputConnection d(InputConnection inputConnection, EditorInfo editorInfo, c cVar) {
        c0.b.d(inputConnection, "inputConnection must be non-null");
        c0.b.d(editorInfo, "editorInfo must be non-null");
        c0.b.d(cVar, "onCommitContentListener must be non-null");
        if (Build.VERSION.SDK_INT >= 25) {
            return new a(inputConnection, false, cVar);
        }
        if (f0.c.a(editorInfo).length == 0) {
    ...
    public static /* synthetic */ boolean f(View view, f fVar, int i10, Bundle bundle) {
        ...
        if (p0.N(view, new d.a(new ClipData(fVar.b(), new ClipData.Item(fVar.a())), 2).d(fVar.c()).b(bundle).a()) != null) {
            return false;
        }
        return true;
    }
