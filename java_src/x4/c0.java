...
public abstract class c0 {
    ...
    private static final Pattern f32281a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f32282b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");
    ...
    */
    public static long b(java.lang.String r9, java.lang.String r10) {
        ...
        L28:
            ...
            if (r0 != 0) goto La4
            java.util.regex.Pattern r0 = x4.c0.f32281a
            java.util.regex.Matcher r0 = r0.matcher(r10)
            boolean r5 = r0.matches()
            if (r5 == 0) goto La4
            r5 = 2
            java.lang.String r5 = r0.group(r5)     // Catch: java.lang.NumberFormatException -> L8d
            java.lang.Object r5 = y4.a.e(r5)     // Catch: java.lang.NumberFormatException -> L8d
            ...
            java.lang.Object r0 = y4.a.e(r0)     // Catch: java.lang.NumberFormatException -> L8d
        ...
        L64:
            ...
            y4.r.i(r2, r9)     // Catch: java.lang.NumberFormatException -> L8d
        ...
        La4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: x4.c0.b(java.lang.String, java.lang.String):long");
    }
    ...
    public static long c(String str) {
        ...
        Matcher matcher = f32282b.matcher(str);
        if (!matcher.matches()) {
            return -1L;
        }
