...
final class g {
    ...
    private final List f29012a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    private final List f29013b = new ArrayList();

    private void a(int[] iArr, String str) {
        this.f29012a.add(iArr);
        this.f29013b.add(str);
    }
    ...
    private synchronized void b() {
        ...
        a(new int[]{594}, "RO");
        a(new int[]{599}, "HU");
        a(new int[]{PipesConfigBase.DEFAULT_STALE_FETCHER_TIMEOUT_SECONDS, 601}, "ZA");
        a(new int[]{603}, "GH");
        a(new int[]{608}, "BH");
        a(new int[]{609}, "MU");
        a(new int[]{611}, "MA");
    ...
    public String c(String str) {
        ...
        for (int i11 = 0; i11 < size && parseInt >= (i10 = (iArr = (int[]) this.f29012a.get(i11))[0]); i11++) {
            if (iArr.length != 1) {
                i10 = iArr[1];
            }
            if (parseInt <= i10) {
                return (String) this.f29013b.get(i11);
            }
        }
        return null;
    }
