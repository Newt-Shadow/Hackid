...
public abstract class a {
    ...
    protected final r.a f3526a;

    /* renamed from: b  reason: collision with root package name */
    protected final r.a f3527b;

    /* renamed from: c  reason: collision with root package name */
    protected final r.a f3528c;
    ...
    private Class c(Class cls) {
        Class cls2 = (Class) this.f3528c.get(cls.getName());
        if (cls2 == null) {
            Class<?> cls3 = Class.forName(String.format("%s.%sParcelizer", cls.getPackage().getName(), cls.getSimpleName()), false, cls.getClassLoader());
            this.f3528c.put(cls.getName(), cls3);
            return cls3;
        }
        return cls2;
    }
    ...
    private Method d(String str) {
        Method method = (Method) this.f3526a.get(str);
        if (method == null) {
            System.currentTimeMillis();
            Method declaredMethod = Class.forName(str, true, a.class.getClassLoader()).getDeclaredMethod("read", a.class);
            this.f3526a.put(str, declaredMethod);
    ...
    private Method e(Class cls) {
        Method method = (Method) this.f3527b.get(cls.getName());
        if (method == null) {
            Class c10 = c(cls);
            System.currentTimeMillis();
            Method declaredMethod = c10.getDeclaredMethod("write", cls, a.class);
            this.f3527b.put(cls.getName(), declaredMethod);
            return declaredMethod;
        }
        return method;
    }
    ...
    protected void K(n1.a aVar, a aVar2) {
        try {
    ...
    public void M(n1.a aVar, int i10) {
        w(i10);
        L(aVar);
    }
    ...
    protected n1.a n(String str, a aVar) {
        try {
            return (n1.a) d(str).invoke(null, aVar);
        } catch (ClassNotFoundException e10) {
            throw new RuntimeException("VersionedParcel encountered ClassNotFoundException", e10);
        } catch (IllegalAccessException e11) {
            throw new RuntimeException("VersionedParcel encountered IllegalAccessException", e11);
    ...
    public n1.a v(n1.a aVar, int i10) {
        if (!m(i10)) {
            return aVar;
        }
        return u();
