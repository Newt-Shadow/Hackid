...
public abstract class v {
    ...
    public static class a implements Executor {
        ...
        final Queue f819b = new ArrayDeque();

        /* renamed from: c  reason: collision with root package name */
        final Executor f820c;
        ...
        protected void c() {
            synchronized (this.f818a) {
                Runnable runnable = (Runnable) this.f819b.poll();
                this.f821d = runnable;
                if (runnable != null) {
                    this.f820c.execute(runnable);
                }
            }
        }
        ...
        public void execute(final Runnable runnable) {
            synchronized (this.f818a) {
                this.f819b.add(new Runnable() { // from class: androidx.appcompat.app.u
