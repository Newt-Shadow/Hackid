...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f1209c = -1;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, h.j.N0);
        d0.p0.S(this, context, h.j.N0, attributeSet, obtainStyledAttributes, 0, 0);
        this.f1207a = obtainStyledAttributes.getBoolean(h.j.O0, true);
        obtainStyledAttributes.recycle();
        if (getOrientation() == 1) {
            setStacked(this.f1207a);
        }
    }
    ...
    private void setStacked(boolean z10) {
        ...
        if (this.f1208b != z10) {
            if (!z10 || this.f1207a) {
                ...
                setGravity(i10);
                View findViewById = findViewById(h.f.G);
