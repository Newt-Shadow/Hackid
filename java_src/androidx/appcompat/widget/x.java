...
abstract class x {
    ...
    private static final class a {
        static boolean a(DragEvent dragEvent, TextView textView, Activity activity) {
            ...
            try {
                ...
                d0.p0.N(textView, new d.a(dragEvent.getClipData(), 3).a());
        ...
        static boolean b(DragEvent dragEvent, View view, Activity activity) {
            activity.requestDragAndDropPermissions(dragEvent);
            d0.p0.N(view, new d.a(dragEvent.getClipData(), 3).a());
            return true;
        }
    }
    ...
    public static boolean a(View view, DragEvent dragEvent) {
        if (Build.VERSION.SDK_INT < 31 && dragEvent.getLocalState() == null && d0.p0.w(view) != null) {
            Activity c10 = c(view);
            if (c10 == null) {
    ...
    public static boolean b(TextView textView, int i10) {
        ...
        int i11 = 0;
        if (Build.VERSION.SDK_INT >= 31 || d0.p0.w(textView) == null || (i10 != 16908322 && i10 != 16908337)) {
            return false;
        }
