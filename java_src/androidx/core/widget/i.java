...
public abstract class i {
    ...
    private static class d implements ActionMode.Callback {
        ...
        private final ActionMode.Callback f2097a;

        /* renamed from: b  reason: collision with root package name */
        private final TextView f2098b;

        /* renamed from: c  reason: collision with root package name */
        private Class f2099c;

        /* renamed from: d  reason: collision with root package name */
        private Method f2100d;
        ...
        private Intent a() {
            return new Intent().setAction("android.intent.action.PROCESS_TEXT").setType(MimeTypes.PLAIN_TEXT);
        }
        ...
        private void g(Menu menu) {
            ...
            Context context = this.f2098b.getContext();
            ...
            if (!this.f2102f) {
                ...
                try {
                    ...
                    this.f2099c = cls;
                    this.f2100d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.f2101e = true;
            ...
            try {
                if (this.f2101e && this.f2099c.isInstance(menu)) {
                    declaredMethod = this.f2100d;
                } else {
                ...
                for (int i10 = 0; i10 < c10.size(); i10++) {
                    ...
                    menu.add(0, 0, i10 + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f2098b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f2097a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f2097a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f2097a.onDestroyActionMode(actionMode);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            g(menu);
            return this.f2097a.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static k.a e(TextView textView) {
        ...
        k.a.C0070a c0070a = new k.a.C0070a(new TextPaint(textView.getPaint()));
        c0070a.b(a.a(textView));
        c0070a.c(a.b(textView));
        c0070a.d(d(textView));
        return c0070a.a();
    }
    ...
    public static ActionMode.Callback m(ActionMode.Callback callback) {
        if ((callback instanceof d) && Build.VERSION.SDK_INT >= 26) {
            return ((d) callback).d();
        }
        return callback;
    }
    ...
    public static ActionMode.Callback n(TextView textView, ActionMode.Callback callback) {
        ...
        if (i10 >= 26 && i10 <= 27 && !(callback instanceof d) && callback != null) {
