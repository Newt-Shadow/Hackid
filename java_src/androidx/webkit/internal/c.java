...
public abstract class c {
    ...
    public static a1 i(ServiceWorkerController serviceWorkerController) {
    ...
    public static void q(ServiceWorkerController serviceWorkerController, o1.h hVar) {
        serviceWorkerController.setServiceWorkerClient(new r0(hVar));
    }
}
