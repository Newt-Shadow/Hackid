...
public final class y extends com.google.crypto.tink.shaded.protobuf.x implements p0 {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f15424a[x.d.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15424a[x.d.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15424a[x.d.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15424a[x.d.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15424a[x.d.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15424a[x.d.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends x.a implements p0 {
        ...
        public b t(c cVar) {
            m();
            ((y) this.f8653b).d0(cVar);
            return this;
        }

        public b u(String str) {
            m();
            ((y) this.f8653b).e0(str);
            return this;
        }

        public b v(com.google.crypto.tink.shaded.protobuf.h hVar) {
            m();
            ((y) this.f8653b).f0(hVar);
            return this;
        }
    ...
    public enum c implements z.a {
        ...
        private static final z.b f15431h = new a();
