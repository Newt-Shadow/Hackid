...
public final class j extends com.google.crypto.tink.shaded.protobuf.x implements p0 {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f15397a[x.d.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15397a[x.d.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15397a[x.d.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15397a[x.d.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15397a[x.d.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15397a[x.d.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends x.a implements p0 {
        ...
        public b t(int i10) {
            m();
            ((j) this.f8653b).b0(i10);
            return this;
        }

        public b u(k kVar) {
            m();
            ((j) this.f8653b).c0(kVar);
            return this;
        }
